  ...
  if (isBlocked && !isSubscriptionPage) {
    return (
      <div className="flex flex-col items-center justify-center h-[calc(100vh-4rem)] p-8 text-center space-y-6">
        ...
        <h1 className="text-3xl font-bold text-red-600">Suscripción Requerida</h1>
        <p className="text-xl text-muted-foreground max-w-md">
          Para acceder al sistema, necesitas activar una suscripción. Por favor canjea un cupón de pago o contacta al administrador.
        </p>
        <Link 
